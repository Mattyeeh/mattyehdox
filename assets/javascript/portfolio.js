...
(function () {
    ...
    $(document).ready(function () {
        var links = [
            ...
            {
                name: 'github',
                link: 'http://github.com/mattyeh'
            },

            {
                name: 'telegram',
                link: 'https://t.me/mattyeh'
            },
        ];
        ...
        if (window.mobileAndTabletCheck()) {
            $("#background").replaceWith('<div id="background" style="background-image: url(https://mindiw.me/assets/images/mobile-background.jpg);"></div>');
    ...
    (function () {
        $.getJSON('https://freegeoip.app/json/', function (data) {
            ...
            writeLine(["Joaquin Róbles...", "Granting access to <span style='font-size: 14px; color: #06d;'>[your future dox]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                    ...
                    writeLine(["<i style='color: #F62459'>23-51082047-9 <br> 51082047 <br> mattyeh.cf</i>"], 120, 500, function () {
